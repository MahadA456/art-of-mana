  ...
  export default function ChoicesIntroPage() {
    ...
    return (
      ...
      >
        ...
        <Motion.div 
          className="fixed md:absolute inset-0 md:left-0 md:top-0 md:right-auto md:bottom-0 w-full md:w-[28%] h-full md:h-full flex items-center justify-center bg-black overflow-hidden"
