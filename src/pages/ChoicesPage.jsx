...
export default function ChoicesPage() {
  ...
  return (
    <Motion.div 
      className="w-screen h-screen fixed top-0 left-0 flex flex-col md:flex-row overflow-y-auto md:overflow-y-auto m-0 p-0 box-border [&::-webkit-scrollbar]:hidden"
      style={{
        scrollbarWidth: 'none',
    ...
    >
      ...
      <Motion.div 
        className="fixed md:absolute inset-0 md:left-0 md:top-0 md:right-auto md:bottom-0 w-full md:w-[32%] h-full md:h-full flex items-center justify-center bg-black overflow-hidden"
