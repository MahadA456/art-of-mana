...
const cloudName = import.meta.env.VITE_CLOUDINARY_CLOUD_NAME || 'dp8cecer3';
 ...
 */
export const getCloudinaryImage = (imageName, options = {}) => {
  const {
    width,
    height,
    quality = 'auto',
 ...
 */
export const getResponsiveImage = (imageName, options = {}) => {
  const { baseWidth = 1920, aspectRatio = null } = options;
